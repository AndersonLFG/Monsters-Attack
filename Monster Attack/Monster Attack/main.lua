...
local platform = display.newImageRect( "skullfield.png", 320, 100 )
...
physics.addBody( balloon, "dynamic", { radius=10 } )
balloon.alpha = 1.0
...
local function restoreCannon()
    ...
    balloon.x = display.contentCenterX
    balloon.y = display.contentHeight 
...
local function createMonster()
    ...
    physics.addBody( newMonster, "dynamic", { radius=40, bounce=0.8 } )
...
local badMonster = display.newImageRect(naveGroup, "creature orange.png", 110, 110 )
--entre 40 e 280
...
--atirar:addEventListener("touch", fireLaser)
=======
-----------------------------------------------------------------------------------------
--
-- main.lua
...
>>>>>>> 75d7c35bac5997d344f124859aedda681bb8a5eb
